...
// ── Automation: Async ──
export const playbooksCmd = (wrap) => buildDevCmd('playbooks', 'sys_hub_playbook', ['playbook'], ['name', 'active', 'sys_scope'], wrap, { singular: 'playbook', scopeValidation: true, readOnly: true });
